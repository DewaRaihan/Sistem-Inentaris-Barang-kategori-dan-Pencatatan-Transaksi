...
<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8 mt-8">
    ...
    <form action="{{ route('transaksi.outbound') }}" method="POST" class="space-y-5">
        @csrf

        <div>
            <label class="block text-gray-700 font-medium mb-1">Pilih Barang</label>
            <select name="barang_id" required
                class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-red-500">
        ...
        <div>
            <label class="block text-gray-700 font-medium mb-1">Jumlah Keluar</label>
